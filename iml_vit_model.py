from modules.windowed_attention_vit import ViT as window_attention_vit, SimpleFeaturePyramid, LastLevelMaxPool
...
class IMLViTModel(nn.Module):
    def __init__(
        ...
        """
        super(IMLViTModel, self).__init__()
    ...
    def forward_features(self, image: torch.Tensor, shape=None, *args, **kwargs):
